...
Usage (Docker):
    ...
    # or with custom args:
    docker compose run --rm tactile_inference python3 /app/robomimic/robomimic/scripts/rollout_fots.py \
...
# In Docker: TACTILE_ROOT=/app (set in Dockerfile). Locally override with env var.
TACTILE_ROOT = os.environ.get("TACTILE_ROOT", "/app")
